...
MN_INTERNAL aparse_error mptest__aparse_opt_test_cb(void* user, aparse_state* state, int sub_arg_idx, const char* text, mn_size text_size) {
...
MN_INTERNAL aparse_error mptest__aparse_opt_suite_cb(void* user, aparse_state* state, int sub_arg_idx, const char* text, mn_size text_size) {
    mptest__aparse_state* test_state = (mptest__aparse_state*)user;
    mptest__aparse_name* name;
    MN_ASSERT(text);
    MN__UNUSED(state);
